...
def retrieve_top_k_contexts(question, k=5):
    ...
    retrieve_model = SentenceTransformer("/Users/likhit/Desktop/Projects/RAG/final_model_partial_frezzing")

    index = faiss.read_index("/Users/likhit/Desktop/Projects/RAG/chunk_store/context_index.faiss")
    context_df = pd.read_csv("/Users/likhit/Desktop/Projects/RAG/chunk_store/context_mapping.csv")
